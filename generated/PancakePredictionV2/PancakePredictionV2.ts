...
export class PancakePredictionV2__getUserRoundsResultValue1Struct extends ethereum.Tuple {
  get position(): i32 {
    return this[0].toI32();
  }
...
export class PancakePredictionV2__getUserRoundsResult {
  value0: Array<BigInt>;
  value1: Array<PancakePredictionV2__getUserRoundsResultValue1Struct>;
  value2: BigInt;
...
export class PancakePredictionV2__ledgerResult {
  value0: i32;
  value1: BigInt;
  value2: boolean;
...
export class PancakePredictionV2__roundsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PancakePredictionV2 extends ethereum.SmartContract {
  static bind(address: Address): PancakePredictionV2 {
    return new PancakePredictionV2("PancakePredictionV2", address);
  }
  ...
  getUserRounds(
    ...
    cursor: BigInt,
    size: BigInt
  ): PancakePredictionV2__getUserRoundsResult {
    let result = super.call(
      "getUserRounds",
    ...
    return new PancakePredictionV2__getUserRoundsResult(
      result[0].toBigIntArray(),
      result[1].toTupleArray<
        PancakePredictionV2__getUserRoundsResultValue1Struct
      >(),
      result[2].toBigInt()
    );
  }
  ...
  try_getUserRounds(
    ...
    cursor: BigInt,
    size: BigInt
  ): ethereum.CallResult<PancakePredictionV2__getUserRoundsResult> {
    let result = super.tryCall(
      "getUserRounds",
      "getUserRounds(address,uint256,uint256):(uint256[],(uint8,uint256,bool)[],uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new PancakePredictionV2__getUserRoundsResult(
  ...
  ledger(param0: BigInt, param1: Address): PancakePredictionV2__ledgerResult {
    let result = super.call(
      "ledger",
    ...
    return new PancakePredictionV2__ledgerResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_ledger(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<PancakePredictionV2__ledgerResult> {
    let result = super.tryCall(
      "ledger",
      "ledger(uint256,address):(uint8,uint256,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PancakePredictionV2__ledgerResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
  ...
  rounds(param0: BigInt): PancakePredictionV2__roundsResult {
    let result = super.call(
      "rounds",
    ...
    return new PancakePredictionV2__roundsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rounds(
    param0: BigInt
  ): ethereum.CallResult<PancakePredictionV2__roundsResult> {
    let result = super.tryCall(
      "rounds",
      "rounds(uint256):(uint256,uint256,uint256,uint256,int256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PancakePredictionV2__roundsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
